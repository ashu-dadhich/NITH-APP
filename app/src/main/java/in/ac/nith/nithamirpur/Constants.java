...
public class Constants {
    //Firebase app url
    public static final String FIREBASE_APP = "https://gcmexample-6ba77.firebaseio.com/";
    ...
    public static final String REGISTER_URL = "http://14.139.56.14/app/firebase.php";
}
