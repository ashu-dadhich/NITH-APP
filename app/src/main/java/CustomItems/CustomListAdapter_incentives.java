 ...
 */
public class CustomListAdapter_incentives extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Model> item;

    public CustomListAdapter_incentives(Activity activity, List<Model> item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_row_incentives, null);
